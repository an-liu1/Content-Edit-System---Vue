<template>
    <div>
        ...
        <!-- EditBoard -->
        <el-dialog title="Eidt" :visible.sync="editVisible" width="50%">
        ...
        <el-dialog title="Add" :visible.sync="addVisible" width="35%">
            <el-form ref="addForm" :model="addForm" label-width="150px">
                ...
                <el-form-item label="nameTr">
                    <el-input v-model="addForm.nameTr" @keyup.enter.native="saveNew"></el-input>
                </el-form-item>
                <el-form-item label="nameColor">
                    <el-input v-model="addForm.nameColor"></el-input>
                </el-form-item>
...
export default {
    ...
    methods: {
        async handleData() {
            let address = "?appName=somoplay&sectionName=title&pageName=method";
