    ...
    <div>
        ...
        <div class="container1">
            ...
            >
                ...
                <el-table-column prop="nameEn" label="nameEn" width="285"></el-table-column>
                <el-table-column prop="nameCh" label="nameCh" width="285"></el-table-column>
                <el-table-column prop="nameTr" label="nameTr" width="285"></el-table-column>
        ...
        <el-dialog title="Eidt" :visible.sync="editVisible" width="30%">
            <el-form ref="form" :model="form" label-width="70px">
                <el-form-item label="nameEn">
                    <el-input type="textarea" v-model="form.nameEn"></el-input>
                </el-form-item>
                <el-form-item label="nameCh">
                    <el-input type="textarea" v-model="form.nameCh"></el-input>
                </el-form-item>
                <el-form-item label="nameTr">
                    <el-input type="textarea" v-model="form.nameTr"></el-input>
                </el-form-item>
            </el-form>
        ...
        <el-dialog title="Add" :visible.sync="addVisible" width="30%">
            <el-form ref="addForm" :model="addForm" label-width="110px">
                ...
                <el-form-item label="nameEn">
                    <el-input type="textarea" v-model="addForm.nameEn"></el-input>
                </el-form-item>
                <el-form-item label="nameCh">
                    <el-input type="textarea" v-model="addForm.nameCh"></el-input>
                </el-form-item>
                <el-form-item label="nameTr">
...
export default {
    ...
    methods: {
        async handleData() {
            let address = "?appName=somoplay&sectionName=content&pageName=home";
