    ...
    <div>
        ...
        <div class="container1">
            ...
            >
                ...
                <el-table-column prop="nameColor" label="nameColor"></el-table-column>
                <el-table-column prop="descriptionEn" label="descriptionEn" ></el-table-column>
                <el-table-column prop="descriptionCh" label="descriptionCh"></el-table-column>
                <el-table-column prop="descriptionColor" label="descriptionColor"></el-table-column>
...
export default {
    ...
    created() {
        this.getData("infoList", "somoplay", "contact");
    },
    methods: {
        ...
        // 触发搜索按钮
        // handleSearch() {
        //     this.getData("infoList", "somoplay", "contact", this.query.name);
        // },
        // // 删除操作
