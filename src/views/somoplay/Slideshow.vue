  ...
  <div>
    <div class="crumbs">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>SlideShow</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
...
export default {
  ...
  methods: {
    async handleData() {
      let address = "?appName=somoplay&sectionName=slideShow&pageName=home";
    ...
    beforeAvatarUpload(file) {
      ...
      if (imgAccept.indexOf(file.type) == -1) {
        this.$message.error("We only support PNG, GIF, JPEG, or JPG pictures.");
      }
      if (!isLt2M) {
        this.$message.error("Please upload a picture smaller than 2 MB.!");
      }
